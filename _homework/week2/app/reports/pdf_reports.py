...
PAGE_BACKGROUND_PATHS = {
    1: Path(__file__).parent / "assets" / "background" / "report_background_cover.jpg",
    2: Path(__file__).parent / "assets" / "background" / "report_background_sales.jpg",
    3: Path(__file__).parent / "assets" / "background" / "report_background_occupancy.jpg",
}
PDF_REPORT_PATH = Path(__file__).parent / "docs"
...
def generate_event_dashboard_pdf(
    ...
    output_path = Path(output_path) / f"event_{event_id}_{generated_at}.pdf"
